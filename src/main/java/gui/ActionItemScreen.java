...
public class ActionItemScreen extends JPanel {
	...
	//private static final long serialVersionUID = 1L; //added to remove Serialization warning
	...
	JComboBox<String> statusComboBox = new JComboBox<String>(ActionItemManager.statusStrings);
	...
	private void guiInit() {
		...
		statusComboBox.setBounds(new Rectangle(524, 275, 100, 25));
